  ...
  if (step === "shipped") {
    ...
    return (
      <View style={{ alignItems: 'center', padding: 40, paddingHorizontal: T.S.xl }}>
        ...
        <Text style={{ fontSize: 11, color: T.textLight, marginBottom: 28, fontFamily: 'JetBrainsMono_400Regular' }}>{platformInfo?.label} {'\u2192'} {fmtInfo?.label}</Text>
        <View style={{ backgroundColor: T.bgCard, borderWidth: 1, borderColor: T.border, borderRadius: T.R.lg, padding: T.S.lg, marginBottom: T.S.xl, width: '100%', ...T.shadow }}>
          <Text style={{ fontSize: 9, fontWeight: '700', letterSpacing: 1.1, color: T.green, fontFamily: 'JetBrainsMono_700Bold', marginBottom: 10 }}>MARKED AS POSTED {'\u2713'}</Text>
          {selectedEntries.map(e => (
            <View key={e.id} style={{ padding: T.S.sm, paddingHorizontal: 10, marginBottom: 4, borderRadius: T.R.sm, backgroundColor: T.bgSub, borderLeftWidth: 2, borderLeftColor: T.green }}>
              <Text style={{ color: T.textLight, fontSize: 11, lineHeight: 16.5, fontFamily: 'JetBrainsMono_400Regular', textDecorationLine: 'line-through', opacity: 0.7 }}>{e.text}</Text>
            </View>
          ))}
        </View>
    ...
    <View>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: T.S.xl }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: T.S.sm }}>
          ...
          <Text style={{ fontSize: 10, fontWeight: '800', letterSpacing: 1.3, color: T.accent, fontFamily: 'JetBrainsMono_700Bold' }}>SHIP CONTENT</Text>
        </View>
        <TouchableOpacity onPress={onClose} activeOpacity={0.7} style={{ borderWidth: 1, borderColor: T.border, borderRadius: T.R.sm, paddingVertical: 5, paddingHorizontal: T.S.md }}>
          <Text style={{ fontSize: 10, color: T.textLight, fontFamily: 'JetBrainsMono_400Regular' }}>{'\u2715'} CLOSE</Text>
        </TouchableOpacity>
      </View>
      <View style={{ backgroundColor: T.bgCard, borderWidth: 1, borderColor: T.border, borderRadius: T.R.lg, padding: 14, paddingHorizontal: T.S.lg, marginBottom: T.S.xl, ...T.shadow }}>
        <Text style={{ fontSize: 9, fontWeight: '700', letterSpacing: 1.1, color: T.textLight, fontFamily: 'JetBrainsMono_700Bold' }}>{selectedEntries.length} DUMP{selectedEntries.length !== 1 ? 'S' : ''} SELECTED</Text>
        <View style={{ marginTop: T.S.sm }}>
          {selectedEntries.slice(0, 3).map(e => (
            <Text key={e.id} style={{ color: T.textMid, fontSize: 11, lineHeight: 16.5, marginVertical: 2, fontFamily: 'JetBrainsMono_400Regular', borderLeftWidth: 2, borderLeftColor: TIER_STYLES[e.analysis.tier].text, paddingLeft: 10 }}>{e.text.length > 80 ? e.text.slice(0, 80) + "..." : e.text}</Text>
          ))}
          {selectedEntries.length > 3 && <Text style={{ fontSize: 10, color: T.textFaint, marginTop: 4 }}>+{selectedEntries.length - 3} more</Text>}
        </View>
      </View>
      <Text style={{ fontSize: 9, fontWeight: '700', letterSpacing: 1.1, color: T.textLight, fontFamily: 'JetBrainsMono_700Bold', marginBottom: 14 }}>WHERE ARE YOU SHIPPING?</Text>
        ...
        {PLATFORMS.map(p => (
          <TouchableOpacity key={p.id} onPress={() => selectPlatform(p.id)} activeOpacity={0.7} style={{ flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: T.bgCard, borderWidth: 1, borderColor: T.border, borderRadius: T.R.lg, padding: T.S.lg, paddingHorizontal: 18, ...T.shadow }}>
            ...
            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
              ...
              <Text style={{ fontSize: 10, color: T.textLight, fontFamily: 'JetBrainsMono_400Regular', marginLeft: T.S.sm }}>{p.formats.length} format{p.formats.length !== 1 ? 's' : ''}</Text>
            </View>
    ...
    <View>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: T.S.xl }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: T.S.sm }}>
          ...
          <Text style={{ fontSize: 10, fontWeight: '800', letterSpacing: 1.3, color: T.accent, fontFamily: 'JetBrainsMono_700Bold' }}>{platformData?.label.toUpperCase()} — CHOOSE FORMAT</Text>
        </View>
        <TouchableOpacity onPress={() => setStep("platform")} activeOpacity={0.7} style={{ borderWidth: 1, borderColor: T.border, borderRadius: T.R.sm, paddingVertical: 5, paddingHorizontal: T.S.md }}>
          <Text style={{ fontSize: 10, color: T.textLight, fontFamily: 'JetBrainsMono_400Regular' }}>{'\u2190'} BACK</Text>
        </TouchableOpacity>
      </View>
      <View style={{ gap: T.S.sm }}>
          ...
          <TouchableOpacity key={f.id} onPress={() => selectFormat(f.id, f.needsScript)} activeOpacity={0.7} style={{ backgroundColor: T.bgCard, borderWidth: 1, borderColor: T.border, borderRadius: T.R.lg, padding: T.S.lg, paddingHorizontal: 18, ...T.shadow }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
              ...
              <View style={{ flexDirection: 'row', gap: 6 }}>
                {f.needsScript && <View style={{ backgroundColor: T.accentBg, borderWidth: 1, borderColor: T.accentBorder, paddingVertical: 2, paddingHorizontal: 7, borderRadius: T.R.sm }}><Text style={{ fontSize: 8, fontWeight: '800', letterSpacing: 0.9, color: T.accent, fontFamily: 'JetBrainsMono_700Bold' }}>SCRIPT</Text></View>}
                <View style={{ backgroundColor: T.bgSub, paddingVertical: 2, paddingHorizontal: 7, borderRadius: T.R.sm }}><Text style={{ fontSize: 8, fontWeight: '700', letterSpacing: 0.7, color: T.textLight, fontFamily: 'JetBrainsMono_700Bold' }}>{f.optimal}</Text></View>
              </View>
            </View>
    ...
    <View>
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: T.S.lg }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: T.S.sm }}>
          ...
          <Text style={{ fontSize: 10, fontWeight: '800', letterSpacing: 1.1, color: T.accent, fontFamily: 'JetBrainsMono_700Bold' }}>{isScript ? 'SCRIPT' : 'DRAFT'} — {formatData.label.toUpperCase()}</Text>
          <Text style={{ fontSize: 9, color: T.textFaint, fontFamily: 'JetBrainsMono_400Regular' }}>{platformData?.label}</Text>
        </View>
        <View style={{ flexDirection: 'row', gap: 6 }}>
          <TouchableOpacity onPress={() => setStep("format")} activeOpacity={0.7} style={{ borderWidth: 1, borderColor: T.border, borderRadius: T.R.sm, paddingVertical: 5, paddingHorizontal: 10 }}><Text style={{ fontSize: 9, color: T.textLight, fontFamily: 'JetBrainsMono_400Regular' }}>{'\u2190'}</Text></TouchableOpacity>
          <TouchableOpacity onPress={onClose} activeOpacity={0.7} style={{ borderWidth: 1, borderColor: T.border, borderRadius: T.R.sm, paddingVertical: 5, paddingHorizontal: 10 }}><Text style={{ fontSize: 9, color: T.textLight, fontFamily: 'JetBrainsMono_400Regular' }}>{'\u2715'}</Text></TouchableOpacity>
        </View>
      </View>
      ...
      <View style={{ padding: 10, paddingHorizontal: 14, marginBottom: T.S.lg, borderRadius: T.R.sm, backgroundColor: T.accentBg, borderWidth: 1, borderColor: T.accentBorder, flexDirection: 'row', alignItems: 'center' }}>
        ...
        {isScript && SCRIPT_STRUCTURES[formatId] && (
          <View style={{ backgroundColor: 'rgba(212,137,12,0.15)', borderWidth: 1, borderColor: T.accentBorder, paddingVertical: 4, paddingHorizontal: 10, borderRadius: T.R.sm, marginLeft: 10 }}>
            <Text style={{ fontSize: 10, fontWeight: '700', color: T.accent, fontFamily: 'JetBrainsMono_700Bold' }}>{SCRIPT_STRUCTURES[formatId].totalSeconds >= 60 ? `${Math.floor(SCRIPT_STRUCTURES[formatId].totalSeconds/60)}:${(SCRIPT_STRUCTURES[formatId].totalSeconds%60).toString().padStart(2,"0")}` : `${SCRIPT_STRUCTURES[formatId].totalSeconds}s`}</Text>
          </View>
        )}
      </View>
          ...
          <View style={{ padding: T.S.sm, paddingHorizontal: 14, backgroundColor: T.bgSub, borderBottomWidth: 1, borderBottomColor: T.borderLight }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: T.S.sm }}>
                ...
                <Text style={{ fontSize: 10, fontWeight: '700', color: T.text, fontFamily: 'JetBrainsMono_700Bold', letterSpacing: 0.4 }}>{section.label}</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: T.S.sm }}>
                {section.timestamp && <View style={{ backgroundColor: T.accentBg, borderWidth: 1, borderColor: T.accentBorder, paddingVertical: 2, paddingHorizontal: T.S.sm, borderRadius: T.R.sm }}><Text style={{ fontSize: 9, fontWeight: '700', color: T.accent, fontFamily: 'JetBrainsMono_700Bold' }}>{section.timestamp}</Text></View>}
                {section.durationLabel && <View style={{ backgroundColor: T.bgSub, borderWidth: 1, borderColor: T.border, paddingVertical: 2, paddingHorizontal: 7, borderRadius: T.R.sm }}><Text style={{ fontSize: 9, fontWeight: '600', color: T.textLight, fontFamily: 'JetBrainsMono_600SemiBold' }}>{section.durationLabel}</Text></View>}
              </View>
            </View>
          </View>
          {section.editable && (
            <View style={{ padding: T.S.md, paddingHorizontal: 14 }}>
              {section.rawDump ? <View style={{ padding: T.S.sm, paddingHorizontal: 10, marginBottom: 10, borderRadius: T.R.sm, backgroundColor: 'rgba(212,137,12,0.04)', borderLeftWidth: 2, borderLeftColor: T.accentBorder }}><Text style={{ fontSize: 8, fontWeight: '700', letterSpacing: 0.9, color: T.textFaint, fontFamily: 'JetBrainsMono_700Bold', marginBottom: 3 }}>SOURCE DUMP</Text><Text style={{ fontSize: 10, color: T.textLight, lineHeight: 15, fontFamily: 'JetBrainsMono_400Regular', fontStyle: 'italic' }}>{section.rawDump}</Text></View> : null}
              <TextInput value={editedSections[i] !== undefined ? editedSections[i] : section.text} onChangeText={(text) => updateSection(i, text)} multiline style={{ color: T.text, fontSize: 13, lineHeight: 22, fontFamily: 'JetBrainsMono_400Regular', textAlignVertical: 'top', minHeight: 60 }} />
      ...
      <View style={{ backgroundColor: T.bgCard, borderWidth: 1, borderColor: T.border, borderRadius: T.R.lg, padding: 14, marginTop: T.S.lg, ...T.shadow }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: T.S.md }}>
          <Text style={{ fontSize: 10, color: T.textLight, fontFamily: 'JetBrainsMono_400Regular' }}>{charCount} chars{formatId === "tw_tweet" && charCount > 280 ? <Text style={{ color: T.red }}> over 280</Text> : null}</Text>
